<template>
  <div>
    ...
    <div class="tabs">
      ...
      <div :class="['tab', currentTab === 'news' && 'active']" @click="currentTab = 'news'">News</div>
    </div>

    <WeatherWidget v-if="currentTab === 'weather'" />
    <CurrencyConverter v-if="currentTab === 'currency'" />
...
export default {
  components: { WeatherWidget, CurrencyConverter, News },
  data() {
    return {
      currentTab: 'weather'
    };
